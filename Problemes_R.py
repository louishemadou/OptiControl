...
orig = array([1, 2, 3, 4, 5, 6, 7, 8, 8, 9, 10,
              11, 13, 1, 2, 4, 5, 7, 8, 14, 2, 10])
dest = array([4, 16, 15, 5, 6, 10, 16, 9, 12, 10, 11,
              14, 15, 16, 6, 8, 9, 11, 13, 15, 4, 13])
...
r = array([100, 10, 1000, 100, 100, 10, 1000, 100, 1000, 100, 1000,
           1000, 1000, 10, 10, 100, 100, 1000, 100, 1000, 100, 10])

# Pressions au pied des reservoirs (en m)
pr = array([105, 104, 110])

# Flux aux noeuds de demande (en m3/s)
fd = array([+0.08, -1.30, +0.13, +0.09, +0.16, +0.14, +
            0.12, +0.07, +0.17, +0.11, +0.25, +0.01, +0.13])
